 ...
 * @example <g-verification-code :seconds="seconds" @end="end" @start="start" ref="gCode"
 */
export default {
  name: 'g-verification-code',
  props: {
    seconds: {
      type: [String, Number],
      default: 60
  ...
  methods: {
    checkKeepRunning() {
      ...
      let lastTimestamp = Number(uni.getStorageSync(this.uniqueKey + '_$gCountDownTimestamp'))
      ...
      if (this.keepRunning && lastTimestamp && lastTimestamp > nowTimestamp) {
        ...
        // 清除本地保存的变量
        uni.removeStorageSync(this.uniqueKey + '_$gCountDownTimestamp')
        // 开始倒计时
        this.start()
      } else {
    ...
    setTimeToStorage() {
      ...
      if (this.secNum > 0 && this.secNum <= this.seconds) {
        ...
        uni.setStorage({
          key: this.uniqueKey + '_$gCountDownTimestamp',
