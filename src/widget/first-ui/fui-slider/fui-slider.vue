<!--本文件由FirstUI授权予江苏伟岸纵横科技股份有限公司（手机号： 1302  9  459    8 21，身份证尾号：29 06   7 0）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <view class="fui-slider__wrap-outer">
    ...
    <view
      ...
      :style="{ width: width + 'px', height: (blockHeight < height ? height : blockHeight) + 'px' }"
    >
      <view
      ...
      >
        <view
          ...
          :class="{ 'fui-slider__pole-bg': !activeColor }"
    ...
    >
      ...
      <view
        ...
        :class="['fui-slider__handle-left', isAndroid ? 'fui-slider__border' : 'fui-slider__shadow']"
      ></view>
      <view
        class="fui-slider__handle"
        fireEventSync="true"
    ...
    >
      ...
      >
        <view
          class="fui-slider__pole-left"
          :class="['fui-slider__pole-r', activeColor ? '' : 'fui-slider__pole-bg']"
      ...
      <view
        ...
        :class="['fui-slider__handle-left', isRight ? 'fui-slider__handle-zi' : '']"
        @touchstart="touchstart"
