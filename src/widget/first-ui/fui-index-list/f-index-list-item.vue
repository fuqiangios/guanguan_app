<!--本文件由FirstUI授权予江苏伟岸纵横科技股份有限公司（手机号： 1302  9 459    8  21，身份证尾号：2   90 67 0）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <view class="fui-index__list-item" :class="{ 'fui-il__between': subRight }" @tap="onClick">
    <view class="fui-il__content">
    ...
    <view class="fui-il__footer" v-if="model.tags">
      {{ model.tags }}
    </view>
  </view>
</template>
...
.fui-index__list-item {
  ...
  .fui-il__content {
    @apply flex-1 flex items-center justify-between w-full;
  }

  .fui-il__footer {
    @apply mt-1 text-sm text-color-extra;
  }
}
