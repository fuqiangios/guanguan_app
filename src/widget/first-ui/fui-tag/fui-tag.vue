<!--本文件由FirstUI授权予江苏伟岸纵横科技股份有限公司（手机号： 13 0 2945 9    8  21，身份证尾号： 290    670）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <view
    class="fui-tag__wrap"
    :class="[
  ...
  >
    <text
      ...
      :style="{ fontSize: size + 'rpx', lineHeight: size + 'rpx', color: getColor }"
    >
...
.fui-tag__success-light {
  background-color: var(--fui-bg-color-green, rgba(9, 190, 79, 0.05)) !important;
...
.fui-tag__warning-light {
  background-color: var(--fui-bg-color-yellow, rgba(255, 183, 3, 0.1)) !important;
...
.fui-tag__purple-light {
  background-color: var(--fui-bg-color-purple, rgba(104, 49, 255, 0.05)) !important;
