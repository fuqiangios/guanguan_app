<!--本文件由FirstUI授权予江苏伟岸纵横科技股份有限公司（手机号：13     02  9 45 982 1，身份证尾号： 290   67 0）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<template>
  <scroll-view
        ...
        >
          ...
          >
            <view
              ...
              :class="{
                ...
                'fui-tabs__slider-color': !sliderBackground
              }"
              :style="{
          ...
          <view class="fui-tabs__text">
            <text
              ...
              :class="{
                'fui-tabs__selected-color': !selectedColor && tabIndex === index,
            ...
            <text
              :class="{
                'fui-tabs__badge-color': !badgeBackground,
