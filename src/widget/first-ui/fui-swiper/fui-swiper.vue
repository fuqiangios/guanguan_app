<template>
  ...
  >
    ...
    >
      <swiper-item class="fui-swiper-item" v-for="(item, index) in list" :key="index">
        <view
          class="fui-list-image-wrap"
          @tap.stop.prevent="listClick(index)"
          :class="[uCurrent != index ? 'fui-list-scale' : '']"
          :style="{
            borderRadius: `${borderRadius}rpx`,
        ...
        >
          ...
          <view
            ...
            class="fui-swiper-title u-line-1"
            :style="[
              {
 ...
 * @example <fui-swiper :list="list" mode="dot" indicator-pos="bottomRight"></fui-swiper>
 */
export default {
  name: 'fui-swiper',
  props: {
